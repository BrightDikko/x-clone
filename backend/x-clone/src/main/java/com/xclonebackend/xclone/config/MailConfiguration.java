package com.xclonebackend.xclone.config;
...
public class MailConfiguration {
    ...
    private static final String APPLICATION_NAME = "X-Clone";
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        InputStream inputStream = MailConfiguration.class.getResourceAsStream(CREDENTIALS_FILE);
